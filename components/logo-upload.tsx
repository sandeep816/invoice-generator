      ...
      <div className="relative">
        {previewUrl ? (
          <div className="relative w-full h-32 border rounded-md overflow-hidden">
            ...
            <Button variant="destructive" size="icon" className="absolute top-2 right-2 h-6 w-6 z-10" onClick={removeLogo}>
              <X className="h-4 w-4" />
            </Button>
          </div>
        ) : (
          <div className="relative border border-dashed rounded-md p-6 text-center">
